...
const getInitialSeedDatabase = (): PlatformDatabaseSchema => {
  ...
  const allSeedUsers: Record<string, User> = {
    [PRIMARY_USER_ID]: seedUser,
    'usr-ref-1': {
      id: 'usr-ref-1',
      username: 'CryptoBeats_Alex',
      email: 'alex.b@musicfan.com',
      ...
      walletAddress: 'TCryptoAlex99BeatZTRC20OfficialWallet',
      network: 'TRC20',
      balance: 320.0,
      frozenBalance: 0.0,
      totalAssets: 320.0,
      ...
      referredBy: 'JAM888',
      status: 'active',
      validDirectMembersCount: 2,
      totalTeamMembersCount: 3,
      totalTeamDeposit: 1400.0,
      isIncomePaused: false,
      autoCompound: true,
      totalEarnedIncome: 45.80,
      totalVipProfit: 32.00,
      totalTeamCommission: 13.80,
      todayVipProfit: 8.00,
      todayTeamCommission: 0.0,
      todayTicketIncome: 8.00,
      todayConcertIncome: 0.0,
      todayFinancialIncome: 0.0,
      totalDeposit: 500.0,
      totalWithdrawal: 180.0,
      ...
      passwordHint: 'AlexVip#2026!',
      adminNotes: 'Direct Tier 1 VIP Member. Verified deposits and fast payouts.',
    ...
    'usr-ref-2': {
      ...
      walletAddress: 'TElenAudioVipSoundstageTRC20DepositNode',
      network: 'TRC20',
      balance: 850.0,
      frozenBalance: 0.0,
      totalAssets: 850.0,
      ...
      referredBy: 'JAM888',
      status: 'active',
      validDirectMembersCount: 4,
      totalTeamMembersCount: 8,
      totalTeamDeposit: 3600.0,
      isIncomePaused: false,
      autoCompound: true,
      totalEarnedIncome: 142.50,
      totalVipProfit: 95.00,
      totalTeamCommission: 47.50,
      todayVipProfit: 25.50,
      todayTeamCommission: 0.0,
      todayTicketIncome: 25.50,
      todayConcertIncome: 0.0,
      todayFinancialIncome: 0.0,
      totalDeposit: 1200.0,
      totalWithdrawal: 350.0,
      ...
      passwordHint: 'ElenaConcert#99!',
      adminNotes: 'High volume VIP 3 promoter. Strong team expansion in UK/EU.',
    ...
    'usr-ref-3': {
      ...
      walletAddress: '0xDavidLiveVibesBEP20SafeVaultNode',
      network: 'BEP20',
      balance: 180.0,
      frozenBalance: 0.0,
      totalAssets: 180.0,
      ...
      referredBy: 'JAM888',
      status: 'active',
      validDirectMembersCount: 1,
      totalTeamMembersCount: 1,
      totalTeamDeposit: 300.0,
      isIncomePaused: false,
      autoCompound: true,
      totalEarnedIncome: 22.10,
      totalVipProfit: 18.50,
      totalTeamCommission: 3.60,
      todayVipProfit: 3.42,
      todayTeamCommission: 0.0,
      todayTicketIncome: 3.42,
      todayConcertIncome: 0.0,
      todayFinancialIncome: 0.0,
      totalDeposit: 300.0,
      totalWithdrawal: 120.0,
      totalPurchases: 150.0,
      recordExpenditure: 0.0,
      concertExpenditure: 0.0,
      financialExpenditure: 0.0,
      lastLoginAt: new Date(Date.now() - 10 * 3600000).toISOString(),
      lastActiveAt: new Date(Date.now() - 2 * 3600000).toISOString(),
      passwordHint: 'DavidLive#2026',
      adminNotes: 'Consistent daily task executor.',
    ...
    'usr-ref-4': {
      ...
      lastActiveAt: new Date(Date.now() - 40 * 3600000).toISOString(),
      passwordHint: 'MarcusFest#2026',
      adminNotes: 'Pending minimum $30 top-up for active VIP yield qualification.',
      createdAt: new Date(Date.now() - 2 * 86400000).toISOString(),
      isAdmin: false
    },
    'usr-ref-5': {
      id: 'usr-ref-5',
      username: 'Sophia_Synth',
      email: 'sophia@synthwave.fm',
      avatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=400&auto=format&fit=crop&q=80',
      phone: '+1 (555) 919-2244',
      walletAddress: 'TSophiaSynthTier2SubordinateNodeTRC',
      network: 'TRC20',
      balance: 450.0,
      frozenBalance: 0.0,
      totalAssets: 450.0,
      vipLevel: 2,
      referralCode: 'SOPHIA5',
      referredBy: 'ALEX88',
      status: 'active',
      validDirectMembersCount: 3,
      totalTeamMembersCount: 5,
      totalTeamDeposit: 2200.0,
      isIncomePaused: false,
      autoCompound: true,
      totalEarnedIncome: 78.40,
      totalVipProfit: 55.00,
      totalTeamCommission: 23.40,
      todayVipProfit: 11.25,
      todayTeamCommission: 0.0,
      todayTicketIncome: 11.25,
      todayConcertIncome: 0.0,
      todayFinancialIncome: 0.0,
      totalDeposit: 800.0,
      totalWithdrawal: 350.0,
      ...
      passwordHint: 'SynthSophia#88',
      adminNotes: 'Tier 2 subordinate of CryptoBeats_Alex. Reliable VIP performer.',
    ...
    'usr-ref-6': {
      ...
      walletAddress: '0xLucasBassDropBEP20SafeDeposit',
      network: 'BEP20',
      balance: 320.0,
      frozenBalance: 0.0,
      totalAssets: 320.0,
      ...
      totalTeamDeposit: 900.0,
      isIncomePaused: false,
      autoCompound: true,
      totalEarnedIncome: 41.20,
      totalVipProfit: 34.00,
      totalTeamCommission: 7.20,
      todayVipProfit: 8.00,
      todayTeamCommission: 0.0,
      todayTicketIncome: 8.00,
      todayConcertIncome: 0.0,
      ...
      passwordHint: 'BassLucas#2026',
      adminNotes: 'Tier 2 subordinate. Verified account.',
      createdAt: new Date(Date.now() - 4 * 86400000).toISOString(),
      isAdmin: false
    },
    'usr-ref-7': {
      id: 'usr-ref-7',
      username: 'Aria_Treble',
      email: 'aria@treblemusic.org',
      avatar: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=400&auto=format&fit=crop&q=80',
      phone: '+1 (555) 880-1122',
      walletAddress: 'TAriaTrebleMusicTRC20AddressNode77',
      network: 'TRC20',
      balance: 590.0,
      frozenBalance: 0.0,
      totalAssets: 590.0,
      ...
      validDirectMembersCount: 2,
      totalTeamMembersCount: 2,
      totalTeamDeposit: 780.0,
      isIncomePaused: false,
      autoCompound: true,
      totalEarnedIncome: 62.10,
      totalVipProfit: 48.50,
      totalTeamCommission: 13.60,
      todayVipProfit: 14.75,
      todayTeamCommission: 0.0,
      todayTicketIncome: 14.75,
      todayConcertIncome: 0.0,
      todayFinancialIncome: 0.0,
      totalDeposit: 780.0,
      totalWithdrawal: 190.0,
      ...
      passwordHint: 'AriaTreble#77!',
      adminNotes: 'Tier 3 subordinate of team tree. Highly active in live event vouchers.',
